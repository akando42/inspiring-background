...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/index.vue?vue&type=template&id=6b386536&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"container-fluid bg-cover h-screen w-screen grid grid-cols-3 gap-4 p-2",staticStyle:{"background-image":"url('https://source.unsplash.com/1600x900/?hot%20girl')"}},[_vm._ssrNode("<div class=\"h-12 rounded-md flex items-center justify-center text-white font-extrabold text-2xl\"></div> <div class=\"h-12 rounded-md flex items-center justify-center text-white font-extrabold text-2xl\">\n    Motivational Views\n  </div> <div class=\"h-12 rounded-md flex items-center justify-center text-white font-extrabold text-2xl\"></div> <div class=\"bg-blue-100 h-12 rounded-md flex items-center justify-center text-white font-extrabold text-2xl\">\n    1\n  </div> <div class=\"bg-yellow-100 h-12 rounded-md flex items-center justify-center text-white font-extrabold text-2xl\">\n    2\n  </div> <div class=\"bg-red-100 h-12 rounded-md flex items-center justify-center text-white font-extrabold text-2xl\">\n    3\n  </div>")])}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/index.vue?vue&type=template&id=6b386536&
